...
console.log(item);
console.log("item:", name, price, quantity);
...
console.log("personChris:", ageOfChris, firstNameOfChris, lastNameOfChris);
...
console.log("personAlex:", firstNameOfAlex, lastNameOfAlex);
